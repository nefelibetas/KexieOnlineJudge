...
class JwtUtil {
    ...
    fun createToken(str: String?): String {
        ...
        return Jwts.builder()
            ...
            .claim("userId", str)
            .id(uuid)
            .subject(com.fish.keXieOpenJudge.utils.JwtUtil.Companion.SUBJECT)
            .issuedAt(expireDate)
            .issuer(com.fish.keXieOpenJudge.utils.JwtUtil.Companion.ISS)
            .signWith(Keys.hmacShaKeyFor(secret!!.toByteArray()),
                com.fish.keXieOpenJudge.utils.JwtUtil.Companion.ALGORITHM
            )
            .compact();
    }
